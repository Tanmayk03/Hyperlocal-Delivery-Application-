...
const DisplayTable = ({ data, columns }) => { // ✅ Changed from 'column' to 'columns'
  const table = useReactTable({
    data,
    columns, // ✅ This key must be 'columns'
...
DisplayTable.propTypes = {
  ...
  columns: PropTypes.array.isRequired, // ✅ Must match the prop name
};
