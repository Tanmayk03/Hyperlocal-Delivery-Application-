      ...
      <div className='bg-blue-50 p-2 grid gap-4'>
        {
          addressList.map((address, index) => {
            if (!address.status) return null; // skip hidden
        ...
        <button
          onClick={() => setOpenAddress(true)}
          className='h-16 bg-blue-50 border-2 border-dashed flex justify-center items-center cursor-pointer focus:outline-none focus:ring-2 focus:ring-blue-500'
