    ...
    <section className=''>
        ...
        <div className='grid p-3'>
            <form className='grid gap-4' onSubmit={handleSubmit}>
                              ...
                              return(
                                <div key={img+index} className='h-20 mt-1 w-20 min-w-20 bg-blue-50 border relative group'>
                                  ...
                                  <button
                                    ...
                                    className='absolute bottom-0 right-0 p-1 bg-red-600 hover:bg-red-600 rounded text-white hidden group-hover:block cursor-pointer border-none'
                ...
                <div className='grid gap-1'>
                  <label htmlFor='category-select' className='font-medium'>Category</label>
                  <div>
                    <select
                      id='category-select'
                ...
                <div className='grid gap-1'>
                  <label htmlFor='sub-category-select' className='font-medium'>Sub Category</label>
                  <div>
                    <select
